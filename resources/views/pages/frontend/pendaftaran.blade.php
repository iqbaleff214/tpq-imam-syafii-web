        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="breadcrumbs-content left">
                    ...
                    <p>Pendaftaran santri dilaksanakan gelombang 1 yang berlangsung pada 1 Muharram - 1 Safar 1443.</p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-12">
            <div class="single-table wow fadeInUp" data-wow-delay=".7s">
              <p class="popular">Khusus</p>

              <div class="table-head">
                <h4 class="title">
                  SPP A <span>untuk keluarga yang tidak mampu</span>
                </h4>
                <div class="price">
                  <p class="amount">
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="single-table wow fadeInUp" data-wow-delay=".7s">
              <div class="table-head">
                <h4 class="title">
                  SPP B <span>biaya standard</span>
                </h4>
                <div class="price">
                  <p class="amount">
                    <span class="curency" style="font-size: small;">Rp</span>
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="single-table wow fadeInUp" data-wow-delay=".7s">
              <div class="table-head">
                <h4 class="title">
                  SPP C <span>biaya SPP sambil beramal</span>
                </h4>
                <div class="price">
                  <p class="amount">
                    <span class="curency" style="font-size: small;">Rp</span>
...
<section class="call-action section overlay">
      <div class="container">
        <div class="row">
          <div
            class="col-lg-4 col-md-4 col-12 wow fadeInLeft"
            data-wow-delay=".3s"
          >
            <div class="section-title">
          ...
          <div
            class="col-lg-8 col-md-8 col-12 wow fadeInRight"
            data-wow-delay=".4s"
          >
