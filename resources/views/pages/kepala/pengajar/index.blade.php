                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <a href="{{ route('kepala.pengajar.create') }}" class="btn bg-maroon">Pengajar Baru</a>
                                    <a href="{{ route('kepala.pengajar.upload') }}" class="btn bg-maroon">Import</a>
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
    ...
    <script>
        $(function() {
            ...
            $('#datatable-bs').DataTable({
                ajax: "{!! route('kepala.pengajar.index') !!}",
                autoWidth: false,
                responsive: true,
                processing: true,
                serverSide: true,
