                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('kepala.santri.index') }}">Santri</a></li>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <div class="card card-maroon card-outline">
                            <div class="card-body box-profile">
                                ...
                                @if($santri->kelas)
                                    <p class="text-center">
                                        <a href="{{ route('kepala.kelas.show', $santri->kelas) }}"
...
@push('script')
    ...
    <script>
        $(function () {
            ...
            doughnutUrl = "{!! route('kepala.kehadiran.santri.index', $santri) !!}";
            ...
            doughnutHafalanUrl = "{!! route('kepala.santri.hafalan', $santri) !!}";
            ...
            doughnutBelajarUrl = "{!! route('kepala.santri.pembelajaran', $santri) !!}";
            ...
            var table_kehadiran = $('#datatable-kehadiran').DataTable({
                ajax: {
                    url: "{!! route('kepala.kehadiran.santri.index') !!}",
                    data: function (d) {
                        d.bulan = bulan;
            ...
            var table_pembelajaran = $('#datatable-pembelajaran').DataTable({
                ajax: {
                    url: "{!! route('kepala.santri.pembelajaran', $santri) !!}",
                    data: function (d) {
                        d.bulan = bulan;
                    }
                },
            ...
            var table_hafalan = $('#datatable-hafalan').DataTable({
                ajax: {
                    url: "{!! route('kepala.santri.hafalan', $santri) !!}",
                    data: function (d) {
                        d.bulan = bulan;
                    }
                },
        ...
        function generateBar(chart) {
            $.ajax({
                url: "{!! route('kepala.santri.kehadiran', $santri) !!}",
                method: "GET",
                data: {
                    chart: chart.config.type ?? true,
                },
