                        ...
                        <div class="card card-solid">
                            ...
                            <div class="card-body mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="jenis_kelas" id="jenis_kelas" class="custom-select select2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="kurikulum_id" class="custom-select select2">
                        ...
                        <div class="card card-solid">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="pengajar_id" id="pengajar_id" class="custom-select select2">
