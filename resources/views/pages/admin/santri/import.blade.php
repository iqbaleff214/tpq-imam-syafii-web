                            ...
                            <div class="card-body mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="kelas_id" class="custom-select select2 @error('kelas_id') is-invalid @enderror">
                                        <option disabled="disabled" selected="selected">Kosongkan Kelas</option>
                        ...
                        <div class="card card-maroon card-outline">
                            ...
                            <div class="card-body">
                                <ul>
                                    ...
                                    <li>Anda dapat memilih kelas yang akan dimasuki oleh santri di kolom input di atas kolom berkas.</li>
