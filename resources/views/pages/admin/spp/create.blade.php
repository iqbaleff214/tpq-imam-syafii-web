                        ...
                        <div class="card card-solid">
                            ...
                            <div class="card-body mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="santri_id" id="santri_id" class="custom-select select2 @error('santri_id') is-invalid @enderror">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="custom-select select2 @error('status') is-invalid @enderror" id="status" name="status">
                                            <option value="0">Ditagih</option>
