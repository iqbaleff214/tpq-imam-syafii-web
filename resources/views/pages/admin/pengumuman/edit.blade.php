                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                               name="judul" placeholder="Judul" value="{{ old('judul', $pengumuman->judul) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="konten" id="konten" cols="30" rows="30"
                                                  class="form-control @error('konten') is-invalid @enderror">{{ old('konten', $pengumuman->konten) }}</textarea>
