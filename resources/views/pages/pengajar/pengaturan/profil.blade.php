                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('nama', Auth::user()->pengajar->nama) }}" autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="tempat_lahir"
                                                   ...
                                                   value="{{ old('tempat_lahir', Auth::user()->pengajar->tempat_lahir) }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="jenis_kelamin" id="" class="custom-select select2">
                                                <option
                                                    {{ Auth::user()->pengajar->jenis_kelamin=='L' ? 'selected' : '' }} value="L">
                                                    Laki-laki
                                                </option>
                                                <option
                                                    {{ Auth::user()->pengajar->jenis_kelamin=='P' ? 'selected' : '' }} value="P">
                                                    Perempuan
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('no_telp', Auth::user()->pengajar->no_telp) }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="alamat" id="" cols="30" rows="3"
                                                      ...
                                                      placeholder="Alamat">{{ old('alamat', Auth::user()->pengajar->alamat) }}</textarea>
