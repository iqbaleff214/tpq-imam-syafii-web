...
@section('body')
    <div class="col-lg-6 mx-auto">
        ...
        <p class="lead my-4">TPQ Imam Syafi'i Banjarmasin dengan surat ini menyatakan bahwa akun atas nama <span class="fw-bold">{{ $nama }}</span> sebagai <span class="fw-bold">{{ $peran }}</span> berhasil dibuat.</p>
        <p>
            ...
            <table class="table table-borderless">
                <tr>
                    ...
                    <td>:</td>
                    <td class="text-start" style="width: 48%">{{ $username }}</td>
                </tr>
                <tr>
