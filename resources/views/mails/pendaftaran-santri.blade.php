...
@section('body')
    <div class="col-lg-6 mx-auto">
        ...
        <p class="lead my-4">TPQ Imam Syafi'i Banjarmasin dengan surat ini menyatakan bahwa akun atas nama <span class="fw-bold">{{ strtoupper($santri->nama_lengkap) }}</span> sebagai <span class="fw-bold">SANTRI</span> berhasil dibuat.</p>
        <p>
